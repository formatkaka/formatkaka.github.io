...
export function SharedBattleOverlay({ config, loading, onViewBattle }: SharedBattleOverlayProps) {
  return (
    <div className="absolute inset-0 z-20 flex items-center justify-center bg-black/70">
      <div className="w-[90%] max-w-sm bg-white p-8 text-center shadow-xl">
        ...
        <button
          ...
          disabled={loading}
          className="w-full border-0 bg-[#1b2021] px-6 py-3 text-base font-semibold text-white outline-none transition hover:bg-[#333] disabled:cursor-not-allowed disabled:bg-[#ccc]"
          type="button"
        >
